...
class PayPalService {
  Future paypalCheckOut({required BuildContext context, required num totalAmount, required Function(Map<String, dynamic>) onComplete, required Function(bool) loderOnOFF}) async {
    loderOnOFF(true);
    final String payPalClientId = appConfigs.value.paypalPay.paypalClientid.validate();
    final String secretKey = appConfigs.value.paypalPay.paypalSecretkey.validate();
