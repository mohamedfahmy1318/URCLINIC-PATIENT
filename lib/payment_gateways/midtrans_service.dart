...
class MidtransService {
  ...
  Future midtransPaymentCheckout() async {
    ...
    final midtransCustomer = MidtransCustomer(loginUserData.value.firstName, loginUserData.value.lastName, loginUserData.value.email, loginUserData.value.mobile);

    final List<MidtransItem> listitems = [];

    final midtransTransaction = MidtransTransaction(totalAmount.toInt(), midtransCustomer, listitems, skipCustomer: true);
